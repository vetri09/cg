            ...
            <div className="postWrapper">
                <div className="postTop">
                    ...
                    <div className="postTopRight" onClick={ ()=>{ postOption ? setPostOption(false) : setPostOption(true) } }>
                        {
                            isEditOption
                            ? <CancelIcon onClick={()=>{setIsEditOption(false);setPostPicexist(false);setPostContent(post?.content)}} />
                            : <MoreHorizIcon className="horizonIcon"/>
                        }
                        { postOption && 
                        <div className="postOptionBar">
                            <p className="postOptionItem" onClick={()=>{setIsEditOption(true);setPostOption(false)}}>Edit Post</p>
                ...
                <div className="postCenter">
                    {
                        ...
                        ? 
                        <>
                            <input type="text" className="postContentEdit" value={postContent} onChange={handleContentChange}/>
                            <div className="postImgEdit">
                                {
                                    post.image ? 
                                    <>
                                    <img id='output' alt="" className="postImgPreview" src={post.image}/>                      
                                ...
                                }
                                {
                                    postPicexist &&
                                    <>
                                    <img id='output' alt="" className="postImgPreview" />
                                    </>
                                }
                            </div>
                        </>
                        ...
                        <>
                            ...
                            <img className="postPostImg" src={post?.image} alt="" />
                        </>
                    }
                </div>
                <div className="postBottom">
                    ...
                    <div className="postBottomRight">
                        
                        {
                            isEditOption
                            ? <>
                            <button className="postSaveBtn" onClick={handleEditPost} >Save</button>
                            </>
                            : <>
